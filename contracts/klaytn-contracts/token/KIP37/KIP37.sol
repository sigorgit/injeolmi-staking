...
contract KIP37 is Context, KIP13, IKIP37, IKIP37MetadataURI {
    ...
    function _doSafeTransferAcceptanceCheck(
        ...
        (success, returndata) = to.call(abi.encodeWithSelector(_ERC1155_RECEIVED, operator, from, id, amount, data));
        if (returndata.length != 0 && abi.decode(returndata, (bytes4)) == _ERC1155_RECEIVED) {
            return true;
        }

        (success, returndata) = to.call(abi.encodeWithSelector(_KIP37_RECEIVED, operator, from, id, amount, data));
    ...
    function _doSafeBatchTransferAcceptanceCheck(
        ...
        (success, returndata) = to.call(
            abi.encodeWithSelector(_ERC1155_BATCH_RECEIVED, operator, from, ids, amounts, data)
        );
        ...
        (success, returndata) = to.call(
            abi.encodeWithSelector(_KIP37_BATCH_RECEIVED, operator, from, ids, amounts, data)
        );
